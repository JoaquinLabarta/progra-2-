...
public class ejercicio2 {
    public static void main(String[]args){
        ...
        //--------------------------------Punto B------------------------------------------------------------
        System.out.println("La cantidad de personas con mas de 65 a�os es: "+PuntoB.contador(vector,DIMFV));
        
        //--------------------------------Punto C------------------------------------------------------------
        System.out.println("La informacion de la persona con el dni minimo es: "+PuntoC.dnimin(vector,DIMFV));
        in.close();  
    }
}
/*Imprimo datos
